...
const philly = new City("Philadelphia", "images/phi.jpg", "philly hint");
...
// function for handling each new round
/* function nextRound() {
    // Set picture
    ...
    let usedIndexes = []; // for storing city indexes which were already used
...
function PlayGame() {
    ...
    {
        nextRound(); // This might cause an issue, it might run through all rounds in one go.
    }
        */

    // The below needs to take place basically each round
